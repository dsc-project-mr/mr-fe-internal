    ...
    return (
        ...
        <Box sx={{ minHeight: '100vh', display: 'flex' }}>
            <Box sx={{
                ...
                <TextField sx={{ marginTop: 2 }} id="new-password" label="New Password" type="password" />
                <TextField sx={{ marginTop: 2 }} id="confirm-new-password" label="Confirm New Password" type="password" />
