...
export const DateRangeFilter = ({value, setValue}: DateRangeFilterProps) => {
    ...
    return <DateRangeComponent editableDateInputs={true} onChange={nr => setValue({ start: nr.selection?.startDate, end: nr.selection?.endDate })} ranges={range} moveRangeOnFirstSelection={true} />
};